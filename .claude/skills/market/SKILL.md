...
**ALL output must be in Spanish.** All marketing analysis, recommendations, content, and reports must be in Spanish. Only technical terms, code, platform names, and proper names should remain in English.
