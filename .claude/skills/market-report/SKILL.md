...
**ALL output must be in Spanish.** The entire report including title, findings, recommendations, and all content must be in Spanish. Only technical terms should remain in English.
