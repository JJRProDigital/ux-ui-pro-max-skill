...
**ALL output must be in Spanish.** All content calendar posts, captions, hooks, and recommendations must be in Spanish. Only hashtags and platform names should remain in English.
