...
**ALL output must be in Spanish.** All copy recommendations, examples, and analysis must be in Spanish. Only technical terms and proper names should remain in English.
