...
**ALL output must be in Spanish.** All competitive analysis, findings, and recommendations must be in Spanish. Only company names and technical terms should remain in English.
