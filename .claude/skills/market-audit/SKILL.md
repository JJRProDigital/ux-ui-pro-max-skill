...
**ALL output must be in Spanish.** The report, findings, recommendations, and terminal summary must be written in Spanish. Only technical terms, proper names, and code should remain in English.
